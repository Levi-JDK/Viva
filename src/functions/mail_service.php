...
class MailService
{
    ...
    private function __construct()
    {
        ...
        // Cargamos el remitente desde el .env (fallback con error si no existe)
        $this->fromEmail = $_ENV['MAIL_FROM_ADDRESS'] ?? throw new Exception('ERROR: MAIL_FROM_ADDRESS no configurada en .env');
