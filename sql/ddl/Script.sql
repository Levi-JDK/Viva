...
(
    ...
    nom_plataforma            VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre de la plataforma
    dir_contacto              VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Dirección de contacto
    correo_contacto           VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Correo de contacto
    val_inifact               DECIMAL(12,0)                   NOT NULL            DEFAULT 0,             -- Numeración inicial de facturas
    val_finfact               DECIMAL(12,0)                   NOT NULL CHECK(val_finfact >= val_inifact)DEFAULT 0,  -- Numeración final de facturas
    val_actfact               DECIMAL(12,0)                   NOT NULL CHECK (val_actfact >= val_inifact AND val_actfact <= val_finfact)DEFAULT 0,  -- Número actual
    val_observa               TEXT                                                DEFAULT 'Sin dato',    -- Observación impresa en factura
...
CREATE TABLE IF NOT EXISTS tab_users (
    ...
    mail_user                 VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Correo del usuario
    pass_user                 VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Contraseña (hash)
    nom_user                  VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombres del usuario
    ape_user                  VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Apellidos del usuario
    foto_user                 VARCHAR                                             DEFAULT ('images/profiles/default.webp'),  -- Foto del usuario
    theme_preference          VARCHAR(5)                                          DEFAULT 'light' CHECK (theme_preference IN ('light', 'dark')),  -- Preferencia de tema visual
...
(
    ...
    nom_menu                  VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del menú
...
(
    ...
    nom_banco                 VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del banco
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_color                 VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del color
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_tipo_doc              VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre/código del tipo de documento (CC, PP, etc.)
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    cod_iso                   DECIMAL(3,0)                    NOT NULL            DEFAULT 0,             -- Código ISO numérico
    nom_pais                  VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del país
...
(
    ...
    nom_departamento          VARCHAR(50)                     NOT NULL            DEFAULT 'Sin dato',    -- Nombre de la región
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_ciudad                VARCHAR(50)                     NOT NULL            DEFAULT 'Sin dato',    -- Nombre de la ciudad
    zip_ciudad                VARCHAR(10)                     NOT NULL            DEFAULT 'Sin dato',    -- Código postal
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_grupo                 VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del grupo
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    dir_prod                  VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Dirección del productor
    ...
    tipo_cuenta               DECIMAL(1,0)                    NOT NULL            DEFAULT 0,             -- 1. Ahorros 2. Corriente
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_stand                 VARCHAR                         NOT NULL            DEFAULT 'Sin dato',
    slogan_stand              VARCHAR                         NOT NULL            DEFAULT 'Sin dato',
    descripcion_stand         TEXT                            NOT NULL            DEFAULT 'Sin dato',
    img_stand                 VARCHAR                         NOT NULL            DEFAULT 'Sin dato',
    portada_stand             VARCHAR                         NOT NULL            DEFAULT 'Sin dato',
...
(
    ...
    nom_idioma                VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del idioma
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_moneda                VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre de la moneda
    simbolo                   VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Símbolo de la moneda
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_oficio                VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del oficio
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_materia               VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre de la materia prima
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    nom_categoria             VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre de la categoría
...
(
    ...
    nom_producto              VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre del producto
    stock_productor           DECIMAL(12,0)                   NOT NULL            DEFAULT 0,             -- Stock disponible
...
CREATE TABLE IF NOT EXISTS tab_carrito(
    ...
    cantidad                  INTEGER                         NOT NULL CHECK(cantidad > 0)DEFAULT 0,     -- Cantidad (mínimo 1)
...
CREATE TABLE IF NOT EXISTS tab_resenas(
    ...
    calificacion              INTEGER                         NOT NULL CHECK (calificacion >= 1 AND calificacion <= 5)DEFAULT 0,
    texto_resena              TEXT                            NOT NULL CHECK (LENGTH(TRIM(texto_resena)) > 0)DEFAULT 'Sin dato',
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',
...
(
    ...
    nom_pago                  VARCHAR                         NOT NULL            DEFAULT 'Sin dato',    -- Nombre de la forma de pago
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    val_cantidad              DECIMAL(4,0)                    NOT NULL CHECK(val_cantidad >=1)DEFAULT 0, -- Cantidad vendida
    val_bruto                 DECIMAL(12,2)                   NOT NULL            DEFAULT 0,             -- Valor antes de impuestos/descuentos
    val_neto                  DECIMAL(12,2)                   NOT NULL            DEFAULT 0,             -- Valor final línea
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,  -- Usuario que creó
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,  -- Fecha de creación
    updated_by                VARCHAR                         NOT NULL            DEFAULT 'N/A',         -- Usuario que modificó
    updated_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha de modificación
...
(
    ...
    tipo_movim                BOOLEAN                         NOT NULL            DEFAULT FALSE,         -- TRUE=entrada / FALSE=salida (venta)
    cantidad                  DECIMAL(7,0)                    NOT NULL CHECK(cantidad >= 1)DEFAULT 0,    -- Cantidad del movimiento
    ref_factura               DECIMAL(7,0)                    NOT NULL            DEFAULT 0                   ,            -- FK trazabilidad → tab_enc_fact
    created_at                TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT CURRENT_TIMESTAMP,
    created_by                VARCHAR                         NOT NULL            DEFAULT current_user,
    is_deleted                BOOLEAN                         NOT NULL            DEFAULT FALSE,
...
(
    ...
    token_reset               VARCHAR(6)                      NOT NULL            DEFAULT 'Sin dato',    -- Código OTP de 6 dígitos
    expira_at                 TIMESTAMP WITHOUT TIME ZONE     NOT NULL            DEFAULT '1900-01-01 00:00:00',  -- Fecha/hora de expiración
